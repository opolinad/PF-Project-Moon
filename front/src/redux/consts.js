...
export const SEARCHING_ACTION="SEARCHING_ACTION";
export const SEARCHING_DATABASE="SEARCHING_DATABASE";
...
export const FEED_NEXT_PAGE_DATABASE="FEED_NEXT_PAGE_DATABASE";
export const SEARCH_RESET_OPTIONS_CATEGORY="SEARCH_RESET_OPTIONS_CATEGORY"
