...
passport.use(new Strategy({
  ...
  callbackURL: process.env.NODE_ENV === "production"?"https://protocolmoon.herokuapp.com/api/login/microsoft/callback":"http://localhost:3001/api/login/microsoft/callback",
  scope: ['user.read']
},
